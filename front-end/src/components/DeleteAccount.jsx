...
const DeleteAccount = () => {
  ...
  return (
    <div className='flex justify-center h-[calc(100vh-126px)] bg-slate-50'>
      ...
      <form onSubmit={handleDelete} className='bg-slate-700 h-96 w-1/2 mt-16 border rounded-2xl'>
      <h1 className='font-bold md:p-10 pt-0 md:text-5xl text-red-700 text-2xl'>Delete Account</h1>
          <input
          className='border rounded-full md:p-3 md:mb-10 md:text-2xl text-xl w-1/2 p-1'
